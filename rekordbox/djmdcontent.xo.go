...
type DjmdContent struct {
	...
	FolderPath        nulltype.NullString  `json:"FolderPath"`           // FolderPath
	FileNameL         nulltype.NullString  `json:"FileNameL"`            // FileNameL
	FileNameS         nulltype.NullString  `json:"FileNameS"`            // FileNameS
	Title             nulltype.NullString  `json:"Title"`                // Title
	ArtistID          nulltype.NullString  `json:"ArtistID"`             // ArtistID
	AlbumID           nulltype.NullString  `json:"AlbumID"`              // AlbumID
	GenreID           nulltype.NullString  `json:"GenreID"`              // GenreID
	...
	BitRate           nulltype.NullInt64   `json:"BitRate"`              // BitRate
	BitDepth          nulltype.NullInt64   `json:"BitDepth"`             // BitDepth
	Commnt            nulltype.NullString  `json:"Commnt"`               // Commnt
	FileType          nulltype.NullInt64   `json:"FileType"`             // FileType
	Rating            nulltype.NullInt64   `json:"Rating"`               // Rating
	ReleaseYear       nulltype.NullInt64   `json:"ReleaseYear"`          // ReleaseYear
	RemixerID         nulltype.NullString  `json:"RemixerID"`            // RemixerID
	LabelID           nulltype.NullString  `json:"LabelID"`              // LabelID
	OrgArtistID       nulltype.NullString  `json:"OrgArtistID"`          // OrgArtistID
	KeyID             nulltype.NullString  `json:"KeyID"`                // KeyID
	StockDate         nulltype.NullString  `json:"StockDate"`            // StockDate
	ColorID           nulltype.NullString  `json:"ColorID"`              // ColorID
	DJPlayCount       nulltype.NullInt64   `json:"DJPlayCount"`          // DJPlayCount
	ImagePath         nulltype.NullString  `json:"ImagePath"`            // ImagePath
	MasterDBID        nulltype.NullString  `json:"MasterDBID"`           // MasterDBID
	MasterSongID      nulltype.NullString  `json:"MasterSongID"`         // MasterSongID
	AnalysisDataPath  nulltype.NullString  `json:"AnalysisDataPath"`     // AnalysisDataPath
	SearchStr         nulltype.NullString  `json:"SearchStr"`            // SearchStr
	FileSize          nulltype.NullInt64   `json:"FileSize"`             // FileSize
	DiscNo            nulltype.NullInt64   `json:"DiscNo"`               // DiscNo
	ComposerID        nulltype.NullString  `json:"ComposerID"`           // ComposerID
	Subtitle          nulltype.NullString  `json:"Subtitle"`             // Subtitle
	SampleRate        nulltype.NullInt64   `json:"SampleRate"`           // SampleRate
	DisableQuantize   nulltype.NullInt64   `json:"DisableQuantize"`      // DisableQuantize
	Analysed          nulltype.NullInt64   `json:"Analysed"`             // Analysed
	ReleaseDate       nulltype.NullString  `json:"ReleaseDate"`          // ReleaseDate
	DateCreated       nulltype.NullString  `json:"DateCreated"`          // DateCreated
	ContentLink       nulltype.NullInt64   `json:"ContentLink"`          // ContentLink
	Tag               nulltype.NullString  `json:"Tag"`                  // Tag
	ModifiedByRBM     nulltype.NullString  `json:"ModifiedByRBM"`        // ModifiedByRBM
	HotCueAutoLoad    nulltype.NullString  `json:"HotCueAutoLoad"`       // HotCueAutoLoad
	DeliveryControl   nulltype.NullString  `json:"DeliveryControl"`      // DeliveryControl
	DeliveryComment   nulltype.NullString  `json:"DeliveryComment"`      // DeliveryComment
	CueUpdated        nulltype.NullString  `json:"CueUpdated"`           // CueUpdated
	AnalysisUpdated   nulltype.NullString  `json:"AnalysisUpdated"`      // AnalysisUpdated
	TrackInfoUpdated  nulltype.NullString  `json:"TrackInfoUpdated"`     // TrackInfoUpdated
	Lyricist          nulltype.NullString  `json:"Lyricist"`             // Lyricist
	ISRC              nulltype.NullString  `json:"ISRC"`                 // ISRC
	SamplerTrackInfo  nulltype.NullInt64   `json:"SamplerTrackInfo"`     // SamplerTrackInfo
	SamplerPlayOffset nulltype.NullInt64   `json:"SamplerPlayOffset"`    // SamplerPlayOffset
	SamplerGain       nulltype.NullFloat64 `json:"SamplerGain"`          // SamplerGain
	VideoAssociate    nulltype.NullString  `json:"VideoAssociate"`       // VideoAssociate
	LyricStatus       nulltype.NullInt64   `json:"LyricStatus"`          // LyricStatus
	ServiceID         nulltype.NullInt64   `json:"ServiceID"`            // ServiceID
	OrgFolderPath     nulltype.NullString  `json:"OrgFolderPath"`        // OrgFolderPath
	...
	ExtInfo           nulltype.NullString  `json:"ExtInfo"`              // ExtInfo
	RbFileID          nulltype.NullString  `json:"rb_file_id"`           // rb_file_id
	DeviceID          nulltype.NullString  `json:"DeviceID"`             // DeviceID
	RbLocalFolderPath nulltype.NullString  `json:"rb_LocalFolderPath"`   // rb_LocalFolderPath
	SrcID             nulltype.NullString  `json:"SrcID"`                // SrcID
	SrcTitle          nulltype.NullString  `json:"SrcTitle"`             // SrcTitle
	SrcArtistName     nulltype.NullString  `json:"SrcArtistName"`        // SrcArtistName
	SrcAlbumName      nulltype.NullString  `json:"SrcAlbumName"`         // SrcAlbumName
	SrcLength         nulltype.NullInt64   `json:"SrcLength"`            // SrcLength
