...
func (c *Client) Insert{{ $t.GoName }}(ctx context.Context, {{ short $t}} *{{ $t.GoName }}) error {
	db := c.db
...
func (c *Client) Update{{ $t.GoName }}(ctx context.Context, {{ short $t}} *{{ $t.GoName }}) error {
	db := c.db
...
func (c *Client) Save{{ $t.GoName }}(ctx context.Context, {{ short $t}} *{{ $t.GoName }}) error {
	if {{ short $t }}.Exists() {
		return c.Update{{ $t.GoName }}({{ if context }}ctx, {{ end }}{{ short $t }})
	}
	return c.Insert{{ $t.GoName }}({{ if context }}ctx, {{ end }}{{ short $t }})
}
...
func (c *Client) Upsert{{ $t.GoName }}(ctx context.Context, {{ short $t}} *{{ $t.GoName }}) error {
	db := c.db
...
func (c *Client) Delete{{ $t.GoName }}(ctx context.Context, {{ short $t}} *{{ $t.GoName }}) error {
	db := c.db
